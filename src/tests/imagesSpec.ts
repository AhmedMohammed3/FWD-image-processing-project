...
describe('getResizedImage', (): void => {
    ...
    describe('GET /', (): void => {
        ...
        it('should return a 404 status code with "Image not found" message in body', (): void => {
            Request.get(
                'http://localhost:3001/api/images?filename=notfoundimage.jpg&width=100&height=200',
                (err, res): void => {
        ...
        it('should return a 400 status code with "Width and height are required" message in body', (): void => {
            Request.get(
                'http://localhost:3001/api/images?filename=fjord.jpg',
                (err, res): void => {
        ...
        it('should return a 200 status code', (): void => {
            Request.get(
                'http://localhost:3001/api/images?filename=fjord.jpg&width=150&height=100',
                (err, res): void => {
